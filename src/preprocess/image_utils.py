...
def upload_directory_to_s3(s3_client, bucket_name, object_prefix: str, dirpath: str, filenames: List[str], num_workers: int = 16):
    ...
    for _ in tqdm(mpp.ThreadPool(num_workers).istarmap(thread_f, zip(filepaths, object_names)), total=len(filenames)):
        pass
